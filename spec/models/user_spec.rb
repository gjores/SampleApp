...
describe "passwords" do
  ...
  describe "password encryption" do
  	...
  	it "password encryption should not be blank" do
  ...
  describe "authenticate method" do
  	...
  	it "should return nil on a email/pass missmatch" do
  		User.authenticate(@attr[:email], "wrongpass").should be_nil
  	end

  	it "should return nil on no user email" do
  		User.authenticate("no@email.com", @attr[:password]).should be_nil
  	end

  	it "should return user on authenticate on match" do
